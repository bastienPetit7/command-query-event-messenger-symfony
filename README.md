...
There is enough examples in this project to see how to implement every type of Bus, so, I'm not to go deeper to explain the classes, but if you need some information you can [contact me](http://www.antoniobuenosvinos.com/hablamos/)
...
Where you defined how symfony messenger is going to serialize and deserialize the Events (the only which is going to store).  
...
> Of course all this information is better explained here: [https://symfony.com/doc/current/messenger.html](https://symfony.com/doc/current/messenger.html)
...
> Our application is about a store who sell products which are provided from a warehouse and a Finance department who buy those products.  
>
> We have 5 Bounded Context, 3 of business nature and 2 of technical nature.  
>
...
> Let's continue with the business Bounded Context, but first some highlights:  
>
...
- Process of the queues
  > Depending on how the project has been configured, there are several ways to launch the consumers.  
  >
...
On [http://localhost/](http://localhost/) you can navigate through the information generated for you and the application
...
- [https://www.tailwindawesome.com/resources/astrolus/demo](https://www.tailwindawesome.com/resources/astrolus/demo)
- [https://tailwindcss.com/docs/guides/symfony](https://tailwindcss.com/docs/guides/symfony)
